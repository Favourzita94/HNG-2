        ...
        <div key={movie.id}>
          ...
          <div>
            <p className='favourite'>
              ...
              <span className={isClicked ? 'change' : 'fa-heart'} onClick={handleClick}>
                <AiOutlineStar />
              </span>
            </p>
            ...
            <div className='gif-container'>
              <div>
                <img src={mypic} alt='thumbnail' /> <span>{movie.vote_count}</span>
              </div>
              <div>
                <img src={pic2} alt='thumbnail' /> <span>{movie.popularity}</span>
              </div>
            </div>
          </div>
        </div>
